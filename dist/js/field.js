...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-text-linked', __webpack_require__(3));
  Vue.component('detail-text-linked', __webpack_require__(6));
  Vue.component('form-text-linked', __webpack_require__(9));
});
                  ...
                  _vm.hasUrl
                    ? _c(
                        "a",
                        {
                          ...
                          staticClass:
                            "whitespace-no-wrap no-underline dim text-primary font-bold",
                          attrs: { href: _vm.field.url }
                        },
